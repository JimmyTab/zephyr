...
#define PTE_PPN_SHIFT  12  // Physical Page Number (PPN) shift (aligns to 4 KiB)
#define PTE_PPN_MASK   0xFFFFF000 // Mask for PPN extraction
#define PTE_PPN_POS    10  // Position of PPN in PTE (Sv32 stores it at bits 31-10)
